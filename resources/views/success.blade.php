...
@section('content')
        ...
        <div class="pay-now my-4">
            <div class="row">
                <div class="col-12 text-center">
                    <div class="h4 text-dark my-4"><strong>You have completed your KYC Successfully</strong></div>
                </div>
                <div class="col-12 text-center">
                    <div class="text-dark my-2">Please copy the data below and send it to your admin chat.<br><br></div>
                </div>
                <div class="col-12 text-center">
                    <div class="d-flex payid-value my-2 gap-2 align-items-center" style='word-break: break-all;'>
                        <span id="copy31" style="width: 100%;">{{$fullname}}<br>{{$email}}</span>
                        <svg id="copy32" width="30px" height="30px" viewBox="0 0 24 24" fill="none" style="cursor: pointer">
                ...
                <span style="font-size: 25px; color: green">Welcome and Good Luck!</span>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        const item = document.querySelector("#copy31");
        const item2 = document.querySelector("#copy32");
        ...
        // const item = document.querySelector(".payid-value");
        // const item2 = document.querySelector(".bi-copy");
        //
        // item.onclick = function () {document.execCommand("copy");}
        ...
        //         if (successful) {
        //             Swal.fire("Link has been copied!", "success", "success");
        //         } else {
        //             Swal.fire("Copy command was unsuccessful", "error", "error");
        //         }
        //     } catch (err) {
        //         console.error("Ошибка при копировании: ", err);
        //         Swal.fire("Copy failed", "error", "error");
        //     }
        //
